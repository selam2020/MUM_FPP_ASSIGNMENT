  ...
  // Resizing the list
   ...
   // Return the size
	...
	public static void main(String[] args) {
		...
		list.add(new Person("Eden", "esiet", 30));
		list.add(new Person("danu", "ghide", 31));
		list.add(new Person("Samuel", "ghide", 32));
		list.add(new Person("Mussie", "ghide", 55));
		System.out.println("\n Size() : " + list.size() + " is\n " + list);
		list.remove("eden");
		System.out.println("\n Size() : " + list.size() + " is \n" + list);
		list.insert(new Person("rahel", "jhon", 32), 2);
		System.out.println("\n Searching of samuel: " + list.find("samuel"));
